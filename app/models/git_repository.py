...
class GitRepository(Base):
    ...
    url: Mapped[str | None] = mapped_column(String(512), nullable=True)  # Deprecated: source-build removed
    auth_type: Mapped[GitAuthType] = mapped_column(Enum(GitAuthType, name="gitauthtype"), default=GitAuthType.none)
    ssh_key_encrypted: Mapped[str | None] = mapped_column(Text)  # Deprecated: source-build removed
