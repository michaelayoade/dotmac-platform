...
async def async_client(
    ...
    from dotmac.shared.auth.core import get_current_user as core_get_current_user
    from dotmac.shared.auth.dependencies import get_current_user as dep_get_current_user
