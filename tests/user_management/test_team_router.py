...
from dotmac.shared.user_management.models import Team, TeamMember
from dotmac.shared.user_management.schemas import (
    TeamCreate,
    TeamListResponse,
    TeamMemberCreate,
...
from dotmac.shared.user_management.team_service import TeamService
...
class TestCreateTeam:
    ...
    async def test_create_team_success(self, sample_team, current_user, mock_team_service):
        ...
        from dotmac.shared.user_management.team_router import create_team
...
class TestListTeams:
    ...
    async def test_list_teams_success(self, sample_team, current_user, mock_team_service):
        ...
        from dotmac.shared.user_management.team_router import list_teams
...
class TestGetTeam:
    ...
    async def test_get_team_success(self, sample_team, current_user, mock_team_service):
        ...
        from dotmac.shared.user_management.team_router import get_team
...
class TestGetTeamBySlug:
    ...
    async def test_get_team_by_slug_success(self, sample_team, current_user, mock_team_service):
        ...
        from dotmac.shared.user_management.team_router import get_team_by_slug
...
class TestUpdateTeam:
    ...
    async def test_update_team_success(self, sample_team, current_user, mock_team_service):
        ...
        from dotmac.shared.user_management.team_router import update_team
...
class TestDeleteTeam:
    ...
    async def test_delete_team_success(self, sample_team, current_user, mock_team_service):
        ...
        from dotmac.shared.user_management.team_router import delete_team
...
class TestAddTeamMember:
    ...
    async def test_add_team_member_success(
        ...
        from dotmac.shared.user_management.team_router import add_team_member
...
class TestListTeamMembers:
    ...
    async def test_list_team_members_success(
        ...
        from dotmac.shared.user_management.team_router import list_team_members
...
class TestUpdateTeamMember:
    ...
    async def test_update_team_member_success(
        ...
        from dotmac.shared.user_management.team_router import update_team_member
...
class TestRemoveTeamMember:
    ...
    async def test_remove_team_member_success(
        ...
        from dotmac.shared.user_management.team_router import remove_team_member
...
class TestGetUserTeams:
    ...
    async def test_get_user_teams_success(self, sample_team, current_user, mock_team_service):
        ...
        from dotmac.shared.user_management.team_router import get_user_teams
...
class TestGetMyTeams:
    ...
    async def test_get_my_teams_success(self, sample_team, current_user, mock_team_service):
        ...
        from dotmac.shared.user_management.team_router import get_my_teams
