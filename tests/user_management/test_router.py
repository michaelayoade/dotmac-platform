...
from dotmac.shared.user_management.router import (
...
class TestUserProfileEndpoints:
    ...
    async def test_get_current_user_profile_success(
        ...
        # Arrange
        from dotmac.shared.user_management.router import get_current_user_profile
    ...
    async def test_update_current_user_profile_success(
        ...
        # Arrange
        from dotmac.shared.user_management.router import update_current_user_profile
    ...
    async def test_change_password_success(self, current_user, mock_user_service):
        ...
        # Arrange
        from dotmac.shared.user_management.router import change_password
...
class TestUserManagementEndpoints:
    ...
    async def test_list_users_success(
        ...
        # Arrange
        from dotmac.shared.user_management.router import list_users
    ...
    async def test_create_user_success(
        ...
        # Arrange
        from dotmac.shared.user_management.router import create_user
    ...
    async def test_get_user_success(
        ...
        # Arrange
        from dotmac.shared.user_management.router import get_user
    ...
    async def test_update_user_success(
        ...
        # Arrange
        from dotmac.shared.user_management.router import update_user
    ...
    async def test_delete_user_success(
        ...
        # Arrange
        from dotmac.shared.user_management.router import delete_user
    ...
    async def test_disable_user_success(
        ...
        # Arrange
        from dotmac.shared.user_management.router import disable_user
    ...
    async def test_enable_user_success(
        ...
        # Arrange
        from dotmac.shared.user_management.router import enable_user
